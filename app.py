...
class UserCreatedPresetsWithUsersAdditionalResource(Resource):
    """Get presets created by a user, along with the associated users and passenger count."""

    # First, define a new model for the response that includes passenger count
    ...
    def get(self, user_id):
        """Retrieve all presets created by specific user id, along with associated users and passenger count."""
        ...
        # Return response with user presets, associated users, and passenger count
...
class UserPassHistoryWithTravellersResource(Resource):
    """Get all utilized passes by a user with traveller details."""

    @api.response(200, 'Success', pass_history_with_travellers_model)
    @api.response(404, 'Resource not found', error_response_model_404)
    def get(self, user_id):
        """Retrieve all utilized passes and associated travellers for a user."""
